...
Цель проекта — разработать портала для размещения компаний из сферы отдыха и развлечений с возможностью онлайн-бронирования (далее Система).
...
3. Функционал бронирования и оплаты мест в заведениях
4. Функционал для менеджера компании


## 2.1. Типы пользователей

Система предусматривает 5 типов пользователей системы: пользователь, менеджер Reserve.by, создатель компании, менеджер компании, суперадмин.
Пользователь явялется рядовым участником Портала, который видит информацию о заведениях, бронирует места, пользуется програмиами лояльности. Менеджер Reserve.by созда аккаунты компаний, которыми в последующем пользуются создатель компании и менеджеры компании. Суперадмин имеет доступ ко всем функциям Портала.
